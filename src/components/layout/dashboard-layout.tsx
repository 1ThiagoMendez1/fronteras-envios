  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50 dark:bg-slate-950">
      ...
      <aside className={cn(
        ...
        <div className="flex h-16 shrink-0 items-center justify-between px-6 bg-sidebar-primary text-sidebar-primary-foreground border-b border-sidebar-border/20">
          ...
          <Button variant="ghost" size="icon" className="lg:hidden text-white hover:bg-white/20" onClick={() => setIsMobileMenuOpen(false)}>
            <X className="h-5 w-5" />
          </Button>
        </div>
        ...
        <div className="p-4 mt-auto border-t border-sidebar-border">
          <div className="flex items-center gap-3 px-2 py-3 rounded-xl bg-sidebar-accent/50 mb-4">
